...
| **Competition closing vibe** (#24) | Pitch: “Rocketlauncher on your Omarchy bar…” | Demo script: open → flips → expand → Space Watch → Esc → optional T−10 toast |
...
| Related internal briefs | `docs/research/rocketlauncher-next-ideas.md`, `docs/research/omarchy-plugins.md`, `DESIGN.md` |
